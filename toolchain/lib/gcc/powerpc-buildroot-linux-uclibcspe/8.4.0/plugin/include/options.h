...
enum opt_code
{
  ...
  OPT_m32 = 1193,                            /* -m32 */
  OPT_m64 = 1194,                            /* -m64 */
  OPT_mabi_altivec = 1195,                   /* -mabi=altivec */
  OPT_mabi_d32 = 1196,                       /* -mabi=d32 */
  OPT_mabi_d64 = 1197,                       /* -mabi=d64 */
  OPT_mabi_elfv1 = 1198,                     /* -mabi=elfv1 */
  OPT_mabi_elfv2 = 1199,                     /* -mabi=elfv2 */
  OPT_mabi_ibmlongdouble = 1200,             /* -mabi=ibmlongdouble */
  OPT_mabi_ieeelongdouble = 1201,            /* -mabi=ieeelongdouble */
  OPT_mabi_no_altivec = 1202,                /* -mabi=no-altivec */
  OPT_mabi_no_spe = 1203,                    /* -mabi=no-spe */
  OPT_mabi_spe = 1204,                       /* -mabi=spe */
  OPT_mads = 1205,                           /* -mads */
  OPT_maix_struct_return = 1206,             /* -maix-struct-return */
  OPT_malign_ = 1207,                        /* -malign- */
  OPT_malign_branch_targets = 1208,          /* -malign-branch-targets */
  OPT_mallow_df_permute = 1209,              /* -mallow-df-permute */
  OPT_mallow_movmisalign = 1210,             /* -mallow-movmisalign */
  OPT_maltivec = 1211,                       /* -maltivec */
  OPT_maltivec_be = 1212,                    /* -maltivec=be */
  OPT_maltivec_le = 1213,                    /* -maltivec=le */
  OPT_malways_hint = 1214,                   /* -malways-hint */
  OPT_mavoid_indexed_addresses = 1215,       /* -mavoid-indexed-addresses */
  OPT_mbig = 1216,                           /* -mbig */
  OPT_mbig_endian = 1217,                    /* -mbig-endian */
  OPT_mbionic = 1218,                        /* -mbionic */
  OPT_mbit_align = 1219,                     /* -mbit-align */
  OPT_mbit_word = 1220,                      /* -mbit-word */
  OPT_mblock_compare_inline_limit_ = 1221,   /* -mblock-compare-inline-limit= */
  OPT_mblock_move_inline_limit_ = 1222,      /* -mblock-move-inline-limit= */
  OPT_mbss_plt = 1223,                       /* -mbss-plt */
  OPT_mcall_ = 1224,                         /* -mcall- */
  OPT_mcmpb = 1225,                          /* -mcmpb */
  OPT_mcompat_align_parm = 1226,             /* -mcompat-align-parm */
  OPT_mcpu_ = 1227,                          /* -mcpu= */
  OPT_mcrypto = 1228,                        /* -mcrypto */
  OPT_mdebug_ = 1229,                        /* -mdebug= */
  OPT_mdirect_move = 1230,                   /* -mdirect-move */
  OPT_mdlmzb = 1231,                         /* -mdlmzb */
  OPT_mdouble_float = 1232,                  /* -mdouble-float */
  OPT_meabi = 1233,                          /* -meabi */
  OPT_mefficient_unaligned_vsx = 1234,       /* -mefficient-unaligned-vsx */
  OPT_memb = 1235,                           /* -memb */
  OPT_mfloat_gprs_ = 1236,                   /* -mfloat-gprs= */
  OPT_mfloat128 = 1237,                      /* -mfloat128 */
  OPT_mfloat128_convert = 1238,              /* -mfloat128-convert */
  OPT_mfloat128_hardware = 1239,             /* -mfloat128-hardware */
  OPT_mfloat128_type = 1240,                 /* -mfloat128-type */
  OPT_mfp_in_toc = 1241,                     /* -mfp-in-toc */
  OPT_mfprnd = 1242,                         /* -mfprnd */
  OPT_mfpu_ = 1243,                          /* -mfpu= */
  OPT_mfriz = 1244,                          /* -mfriz */
  OPT_mfull_toc = 1245,                      /* -mfull-toc */
  /* OPT_mfused_madd = 1246, */              /* -mfused-madd */
  OPT_mgen_cell_microcode = 1247,            /* -mgen-cell-microcode */
  OPT_mglibc = 1248,                         /* -mglibc */
  OPT_mgnu_attribute = 1249,                 /* -mgnu-attribute */
  OPT_mhard_dfp = 1250,                      /* -mhard-dfp */
  OPT_mhard_float = 1251,                    /* -mhard-float */
  OPT_mhtm = 1252,                           /* -mhtm */
  OPT_minsert_sched_nops_ = 1253,            /* -minsert-sched-nops= */
  OPT_misel = 1254,                          /* -misel */
  /* OPT_misel_no = 1255, */                 /* -misel=no */
  /* OPT_misel_yes = 1256, */                /* -misel=yes */
  OPT_mlittle = 1257,                        /* -mlittle */
  OPT_mlittle_endian = 1258,                 /* -mlittle-endian */
  OPT_mlong_double_ = 1259,                  /* -mlong-double- */
  OPT_mlongcall = 1260,                      /* -mlongcall */
  OPT_mlra = 1261,                           /* -mlra */
  OPT_mmfcrf = 1262,                         /* -mmfcrf */
  OPT_mmfpgpr = 1263,                        /* -mmfpgpr */
  OPT_mminimal_toc = 1264,                   /* -mminimal-toc */
  OPT_mmodulo = 1265,                        /* -mmodulo */
  OPT_mmulhw = 1266,                         /* -mmulhw */
  OPT_mmultiple = 1267,                      /* -mmultiple */
  OPT_mmusl = 1268,                          /* -mmusl */
  OPT_mmvme = 1269,                          /* -mmvme */
  OPT_mnewlib = 1270,                        /* -mnewlib */
  OPT_mno_fp_in_toc = 1271,                  /* -mno-fp-in-toc */
  OPT_mno_sum_in_toc = 1272,                 /* -mno-sum-in-toc */
  OPT_mno_toc = 1273,                        /* -mno-toc */
  OPT_mno_traceback = 1274,                  /* -mno-traceback */
  OPT_mno_update = 1275,                     /* -mno-update */
  OPT_moptimize_swaps = 1276,                /* -moptimize-swaps */
  OPT_mpaired = 1277,                        /* -mpaired */
  OPT_mpointers_to_nested_functions = 1278,  /* -mpointers-to-nested-functions */
  OPT_mpopcntb = 1279,                       /* -mpopcntb */
  OPT_mpopcntd = 1280,                       /* -mpopcntd */
  OPT_mpower8_fusion = 1281,                 /* -mpower8-fusion */
  OPT_mpower8_fusion_sign = 1282,            /* -mpower8-fusion-sign */
  OPT_mpower8_vector = 1283,                 /* -mpower8-vector */
  OPT_mpower9_dform = 1284,                  /* -mpower9-dform */
  OPT_mpower9_dform_scalar = 1285,           /* -mpower9-dform-scalar */
  OPT_mpower9_dform_vector = 1286,           /* -mpower9-dform-vector */
  OPT_mpower9_fusion = 1287,                 /* -mpower9-fusion */
  OPT_mpower9_minmax = 1288,                 /* -mpower9-minmax */
  OPT_mpower9_misc = 1289,                   /* -mpower9-misc */
  OPT_mpower9_vector = 1290,                 /* -mpower9-vector */
  /* OPT_mpowerpc = 1291, */                 /* -mpowerpc */
  OPT_mpowerpc_gfxopt = 1292,                /* -mpowerpc-gfxopt */
  OPT_mpowerpc_gpopt = 1293,                 /* -mpowerpc-gpopt */
  OPT_mpowerpc64 = 1294,                     /* -mpowerpc64 */
  OPT_mprioritize_restricted_insns_ = 1295,  /* -mprioritize-restricted-insns= */
  OPT_mprototype = 1296,                     /* -mprototype */
  OPT_mquad_memory = 1297,                   /* -mquad-memory */
  OPT_mquad_memory_atomic = 1298,            /* -mquad-memory-atomic */
  OPT_mrecip = 1299,                         /* -mrecip */
  OPT_mrecip_precision = 1300,               /* -mrecip-precision */
  OPT_mrecip_ = 1301,                        /* -mrecip= */
  OPT_mregnames = 1302,                      /* -mregnames */
  OPT_mrelocatable = 1303,                   /* -mrelocatable */
  OPT_mrelocatable_lib = 1304,               /* -mrelocatable-lib */
  OPT_msave_toc_indirect = 1305,             /* -msave-toc-indirect */
  OPT_msched_costly_dep_ = 1306,             /* -msched-costly-dep= */
  OPT_msched_epilog = 1307,                  /* -msched-epilog */
  OPT_msched_groups = 1308,                  /* -msched-groups */
  OPT_msched_prolog = 1309,                  /* -msched-prolog */
  OPT_msdata = 1310,                         /* -msdata */
  OPT_msdata_ = 1311,                        /* -msdata= */
  OPT_msecure_plt = 1312,                    /* -msecure-plt */
  OPT_mshlib = 1313,                         /* -mshlib */
  OPT_msim = 1314,                           /* -msim */
  OPT_msimple_fpu = 1315,                    /* -msimple-fpu */
  OPT_msingle_float = 1316,                  /* -msingle-float */
  OPT_msingle_pic_base = 1317,               /* -msingle-pic-base */
  OPT_msoft_float = 1318,                    /* -msoft-float */
  OPT_mspe = 1319,                           /* -mspe */
  /* OPT_mspe_no = 1320, */                  /* -mspe=no */
  /* OPT_mspe_yes = 1321, */                 /* -mspe=yes */
  OPT_mstack_protector_guard_offset_ = 1322, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1323,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1324,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1325,                  /* -mstrict-align */
  OPT_mstring = 1326,                        /* -mstring */
  OPT_mstring_compare_inline_limit_ = 1327,  /* -mstring-compare-inline-limit= */
  OPT_msum_in_toc = 1328,                    /* -msum-in-toc */
  OPT_msvr4_struct_return = 1329,            /* -msvr4-struct-return */
  OPT_mtls_markers = 1330,                   /* -mtls-markers */
  OPT_mtls_size_ = 1331,                     /* -mtls-size= */
  OPT_mtoc = 1332,                           /* -mtoc */
  OPT_mtoc_fusion = 1333,                    /* -mtoc-fusion */
  OPT_mtraceback_ = 1334,                    /* -mtraceback= */
  OPT_mtune_ = 1335,                         /* -mtune= */
  OPT_muclibc = 1336,                        /* -muclibc */
  OPT_mupdate = 1337,                        /* -mupdate */
  OPT_mupper_regs = 1338,                    /* -mupper-regs */
  OPT_mupper_regs_df = 1339,                 /* -mupper-regs-df */
  OPT_mupper_regs_di = 1340,                 /* -mupper-regs-di */
  OPT_mupper_regs_sf = 1341,                 /* -mupper-regs-sf */
  OPT_mveclibabi_ = 1342,                    /* -mveclibabi= */
  OPT_mvectorize_builtins = 1343,            /* -mvectorize-builtins */
  OPT_mvrsave = 1344,                        /* -mvrsave */
  /* OPT_mvrsave_no = 1345, */               /* -mvrsave=no */
  /* OPT_mvrsave_yes = 1346, */              /* -mvrsave=yes */
  OPT_mvsx = 1347,                           /* -mvsx */
  OPT_mvsx_align_128 = 1348,                 /* -mvsx-align-128 */
  OPT_mvsx_scalar_double = 1349,             /* -mvsx-scalar-double */
  OPT_mvsx_scalar_float = 1350,              /* -mvsx-scalar-float */
  /* OPT_mvsx_scalar_memory = 1351, */       /* -mvsx-scalar-memory */
  OPT_mvsx_small_integer = 1352,             /* -mvsx-small-integer */
  OPT_mvsx_timode = 1353,                    /* -mvsx-timode */
  OPT_mwarn_altivec_long = 1354,             /* -mwarn-altivec-long */
  OPT_mwarn_cell_microcode = 1355,           /* -mwarn-cell-microcode */
  OPT_mxilinx_fpu = 1356,                    /* -mxilinx-fpu */
  OPT_mxl_compat = 1357,                     /* -mxl-compat */
  OPT_myellowknife = 1358,                   /* -myellowknife */
  OPT_n = 1359,                              /* -n */
  OPT_no_canonical_prefixes = 1360,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1361,              /* -no-integrated-cpp */
  OPT_no_pie = 1362,                         /* -no-pie */
  OPT_nocpp = 1363,                          /* -nocpp */
  OPT_nodefaultlibs = 1364,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1365,                   /* -nostartfiles */
  OPT_nostdinc = 1366,                       /* -nostdinc */
  OPT_nostdinc__ = 1367,                     /* -nostdinc++ */
  OPT_nostdlib = 1368,                       /* -nostdlib */
  OPT_o = 1369,                              /* -o */
  OPT_p = 1370,                              /* -p */
  ...
  OPT_pie = 1375,                            /* -pie */
  OPT_pipe = 1376,                           /* -pipe */
  OPT_posix = 1377,                          /* -posix */
  OPT_print_file_name_ = 1378,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1379,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1380,          /* -print-multi-directory */
  OPT_print_multi_lib = 1381,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1382,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1383,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1384,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1385,               /* -print-prog-name= */
  OPT_print_search_dirs = 1386,              /* -print-search-dirs */
  OPT_print_sysroot = 1387,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1388,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1389,                        /* -profile */
  OPT_pthread = 1390,                        /* -pthread */
  OPT_quiet = 1391,                          /* -quiet */
  OPT_r = 1392,                              /* -r */
  OPT_rdynamic = 1393,                       /* -rdynamic */
  OPT_remap = 1394,                          /* -remap */
  OPT_s = 1395,                              /* -s */
  OPT_save_temps = 1396,                     /* -save-temps */
  OPT_save_temps_ = 1397,                    /* -save-temps= */
  OPT_shared = 1398,                         /* -shared */
  OPT_shared_libgcc = 1399,                  /* -shared-libgcc */
  /* OPT_specs = 1400, */                    /* -specs */
  OPT_specs_ = 1401,                         /* -specs= */
  OPT_static = 1402,                         /* -static */
  OPT_static_libasan = 1403,                 /* -static-libasan */
  OPT_static_libgcc = 1404,                  /* -static-libgcc */
  OPT_static_libgfortran = 1405,             /* -static-libgfortran */
  OPT_static_libgo = 1406,                   /* -static-libgo */
  OPT_static_liblsan = 1407,                 /* -static-liblsan */
  OPT_static_libmpx = 1408,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1409,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1410,               /* -static-libstdc++ */
  OPT_static_libtsan = 1411,                 /* -static-libtsan */
  OPT_static_libubsan = 1412,                /* -static-libubsan */
  OPT_static_pie = 1413,                     /* -static-pie */
  /* OPT_std_c__03 = 1414, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1415, */                /* -std=c++0x */
  OPT_std_c__11 = 1416,                      /* -std=c++11 */
  OPT_std_c__14 = 1417,                      /* -std=c++14 */
  OPT_std_c__17 = 1418,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1419, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1420, */                /* -std=c++1z */
  OPT_std_c__2a = 1421,                      /* -std=c++2a */
  OPT_std_c__98 = 1422,                      /* -std=c++98 */
  OPT_std_c11 = 1423,                        /* -std=c11 */
  OPT_std_c17 = 1424,                        /* -std=c17 */
  /* OPT_std_c18 = 1425, */                  /* -std=c18 */
  /* OPT_std_c1x = 1426, */                  /* -std=c1x */
  /* OPT_std_c89 = 1427, */                  /* -std=c89 */
  OPT_std_c90 = 1428,                        /* -std=c90 */
  OPT_std_c99 = 1429,                        /* -std=c99 */
  /* OPT_std_c9x = 1430, */                  /* -std=c9x */
  OPT_std_f2003 = 1431,                      /* -std=f2003 */
  OPT_std_f2008 = 1432,                      /* -std=f2008 */
  OPT_std_f2008ts = 1433,                    /* -std=f2008ts */
  OPT_std_f2018 = 1434,                      /* -std=f2018 */
  OPT_std_f95 = 1435,                        /* -std=f95 */
  OPT_std_gnu = 1436,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1437, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1438, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1439,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1440,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1441,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1442, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1443, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1444,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1445,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1446,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1447,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1448, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1449, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1450, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1451,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1452,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1453, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1454, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1455,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1456, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1457, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1458, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1459, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1460, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1461,                     /* -std=legacy */
  OPT_symbolic = 1462,                       /* -symbolic */
  OPT_t = 1463,                              /* -t */
  OPT_time = 1464,                           /* -time */
  OPT_time_ = 1465,                          /* -time= */
  OPT_traditional = 1466,                    /* -traditional */
  OPT_traditional_cpp = 1467,                /* -traditional-cpp */
  OPT_trigraphs = 1468,                      /* -trigraphs */
  OPT_u = 1469,                              /* -u */
  OPT_undef = 1470,                          /* -undef */
  OPT_v = 1471,                              /* -v */
  OPT_version = 1472,                        /* -version */
  OPT_w = 1473,                              /* -w */
  OPT_wrapper = 1474,                        /* -wrapper */
  OPT_x = 1475,                              /* -x */
  OPT_z = 1476,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
